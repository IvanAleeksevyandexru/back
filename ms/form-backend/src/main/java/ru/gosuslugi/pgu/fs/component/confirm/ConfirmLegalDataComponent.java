    ...
    private FormDto<ConfirmLegalData> getLegalFormData(FieldComponent component) {
        ...
        if (fields.containsKey(ORG_OGRN_ATTR)) {
            ...
            if(fieldDto.isRequired() && StringUtils.isEmpty(org.getOgrn())) {
                errorDto =  new ErrorDto(RED_LINE_ICON, ERROR_ATTR, FIELD_NOT_FOUND_TITLE_START + OGRN_FIELD_LABEL + FIELD_NOT_FOUND_TITLE_END, DISCLAIMER_DESCRIPTION, null);
                errors.add(errorDto);
            }
        ...
        if (fields.containsKey(ORG_INN_ATTR)) {
            ...
            if(fieldDto.isRequired() && StringUtils.isEmpty(org.getInn())) {
                errorDto =  new ErrorDto(RED_LINE_ICON, ERROR_ATTR, FIELD_NOT_FOUND_TITLE_START + INN_FIELD_LABEL + FIELD_NOT_FOUND_TITLE_END, DISCLAIMER_DESCRIPTION, null);
                errors.add(errorDto);
            }
        ...
        if (fields.containsKey(ORG_KPP_ATTR)) {
            ...
            if(fieldDto.isRequired() && StringUtils.isEmpty(org.getKpp())) {
                errorDto =  new ErrorDto(RED_LINE_ICON, ERROR_ATTR, FIELD_NOT_FOUND_TITLE_START + KPP_FIELD_LABEL + FIELD_NOT_FOUND_TITLE_END, DISCLAIMER_DESCRIPTION, null);
                errors.add(errorDto);
            }
