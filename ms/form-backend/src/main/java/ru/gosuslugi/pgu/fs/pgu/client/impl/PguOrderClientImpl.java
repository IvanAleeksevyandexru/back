...
public class PguOrderClientImpl implements PguOrderClient {
    ...
    private static final String LK_API_ORDERS_PATH = "/lk-api/internal/api/lk/v1/orders/{orderId}?token={userId}@@AL20@@1";
    ...
    private static final String LK_API_FIND_ORDER_WITH_PAYMENT_PATH = "/lk-api/internal/api/lk/v1/orders/{orderId}?embed=PAYMENT";
